...
# СООБЩЕНИЯ ОТ БОТА
start_message = """<b>Вас приветствует магазин - lokk-shop.biz 

Наши контакты:</b>
Jabber:
Telegram:
Сайт автопродаж - https://lokk-shop.biz
...
start_3_message = """<b>Вас приветствует магазин - LOK-BIZ
Работай в LOK-BIZ на лучших условиях!
